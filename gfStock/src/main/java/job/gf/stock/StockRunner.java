...
public class StockRunner {
	static Logger log = LoggerFactory.getLogger(StockRunner.class) ;
	...
	private static boolean parseAddStock(IMarket market,String param){
		...
		if(params.length>3) generator=params[3];
		...
		Stock stock = new Stock(String.valueOf(code),name,total,priceInt,tradeGenerator);
